...
| `MODEL_REQUIRED` | 需要 Oracle 专用模型，通常涉及层级查询、多表插入、PL/SQL、表变换、闪回、会话语义或远程对象引用。 |
...
| `HOOK_ONLY` | 0 | 0.00% |
| `MIXED_MODEL` | 0 | 0.00% |
| `MODEL_REQUIRED` | 15 | 34.09% |
| `REFERENCE_ONLY` | 0 | 0.00% |

剔除 `REFERENCE_ONLY` 后，官方可实现语法组为 44 组。其中当前已覆盖 29 组，未覆盖 15 组。

| 未覆盖分类 | 语法组数 | 占未覆盖 15 组 |
| --- | ---: | ---: |
| `HOOK_ONLY` | 0 | 0.00% |
| `MIXED_MODEL` | 0 | 0.00% |
