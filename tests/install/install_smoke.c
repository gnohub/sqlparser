...
int main(void)
{
	...
	if (expect_true(rc == SQLPARSER_STATUS_OK, "installed view export should succeed") != 0 ||
	    expect_true(view_json != NULL, "installed view export should return text") != 0 ||
	    expect_true(strstr(view_json, "\"statements\"") != NULL, "view export should carry statements") != 0) {
