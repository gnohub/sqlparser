...
| `vastbase-postgresql` | [PostgreSQL 兼容性](https://docs.vastdata.com.cn/zh_CN/VastbaseG100/V3.0.8/1/a9976158894e40398e9268181a597281) | `tests/cases/vastbase_postgresql_dialect_input.json` | 136 | 1 | 137 |
...
- `明确不支持用例` 与对应基础方言保持一致，主要是共享 AST 尚不能安全表达的数据库专属语义。
