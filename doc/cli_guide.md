...
`dialect` 支持 `postgresql`、`mysql`、`oracle`、`sqlserver`、`dameng`、`vastbase-oracle`、`vastbase-mysql`、`vastbase-postgresql`、`vastbase-sqlserver`、`kingbase-oracle`、`kingbase-mysql`、`kingbase-postgresql`、`kingbase-sqlserver`。`vastbase` 是 `vastbase-oracle` 的别名。
