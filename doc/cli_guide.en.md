...
```bash
./bin/sqlparser_cli [--mode view|deparse] [--dialect postgresql|mysql|oracle|sqlserver|dameng|vastbase-oracle|vastbase-mysql|vastbase-postgresql|vastbase-sqlserver|kingbase-oracle|kingbase-mysql|kingbase-postgresql|kingbase-sqlserver] [--compact] [--file PATH] [SQL]
```
...
`dialect` accepts `postgresql`, `mysql`, `oracle`, `sqlserver`, `dameng`, `vastbase-oracle`, `vastbase-mysql`, `vastbase-postgresql`, `vastbase-sqlserver`, `kingbase-oracle`, `kingbase-mysql`, `kingbase-postgresql`, and `kingbase-sqlserver`. `vastbase` is an alias for `vastbase-oracle`.
