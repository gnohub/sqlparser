...
static void sqlparser_free_proto_node(PgQuery__Node *node)
{
	if (node != NULL) {
...
static sqlparser_status_t sqlparser_clone_proto_node(
...
static sqlparser_status_t sqlparser_parse_insert_cell_node_sql(
	const char *sql_text,
	PgQuery__Node **out_node,
	sqlparser_error_t *out_error)
{
...
static sqlparser_status_t sqlparser_parse_update_assignment_node_sql(
	const char *sql_text,
	PgQuery__Node **out_node,
	sqlparser_error_t *out_error)
{
...
static sqlparser_status_t sqlparser_render_insert_cell_node_sql(
	const PgQuery__Node *node,
	char **out_sql,
	sqlparser_error_t *out_error)
{
...
static sqlparser_status_t sqlparser_render_update_assignment_node_sql(
	const PgQuery__Node *node,
	char **out_sql,
	sqlparser_error_t *out_error)
{
...
static sqlparser_value_kind_t sqlparser_node_value_kind(const PgQuery__Node *node)
{
	if (node == NULL) {
