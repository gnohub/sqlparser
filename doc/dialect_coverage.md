...
| 达梦 | `tests/cases/dameng_dialect_input.json` | 185 | 0 | 185 | 100.00% |
| Vastbase PostgreSQL 兼容模式 | `tests/cases/vastbase_postgresql_dialect_input.json` | 203 | 0 | 203 | 100.00% |
| Vastbase MySQL 兼容模式 | `tests/cases/vastbase_mysql_dialect_input.json` | 263 | 0 | 263 | 100.00% |
| Vastbase Oracle 兼容模式 | `tests/cases/vastbase_oracle_dialect_input.json` | 222 | 0 | 222 | 100.00% |
| Vastbase SQL Server 兼容模式 | `tests/cases/vastbase_sqlserver_dialect_input.json` | 607 | 0 | 607 | 100.00% |

九个夹具合计 2840 条 final 用例和 9163 个独立 patch。
